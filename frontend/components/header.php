    ...
    <div class="top-bar bg-brown text-white py-2">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <small class="hotline-email">
                        <span><i class="fas fa-phone"></i> <a href="#">Hotline: 02438222228</a></span>
                        <span class="ms-3"><i class="fas fa-envelope"></i> <a href="#">info@nguyenson.vn</a></span>
                    </small>
                </div>
            ...
            <div class="row align-items-center py-3">
                ...
                <div class="col-md-2">
                    <a href="<?= url('frontend/pages/index.php') ?>" class="logo">
                        <img src="<?= url('frontend/assets/images/logo.png') ?>" alt="Nguyễn Sơn Bakery"
                ...
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?= url('frontend/pages/products/list.php') ?>">Tất cả
                                    sản phẩm</a></li>
                            <li>
                                <hr class="dropdown-divider">
                            </li>
                            <li><a class="dropdown-item"
                                    href="<?= url('frontend/pages/products/list.php?category=banh-ngot') ?>">Bánh
                                    ngọt</a></li>
                            <li><a class="dropdown-item"
                                    href="<?= url('frontend/pages/products/list.php?category=banh-my') ?>">Bánh mỳ</a>
                            </li>
                            <li><a class="dropdown-item"
                                    href="<?= url('frontend/pages/products/list.php?category=banh-sinh-nhat') ?>">Bánh
                                    sinh nhật</a></li>
                            <li><a class="dropdown-item"
                                    href="<?= url('frontend/pages/products/list.php?category=banh-trung-thu') ?>">Bánh
                                    trung thu</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
